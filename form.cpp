    ...
    , ui(new Ui::MainWindow)
{
    ...
    QPalette palette;
    QPixmap pixmap("c:/Users/Sahar/Bureau/project/fomrationx/back55.jpg");
    ...
    ui->logo->setIcon(QIcon("C:/Users/Sahar/Desktop/project/interfce/logo9.png"));
    ui->logo->setIconSize(QSize(150, 150));
    ui->logo->setStyleSheet(commonButtonStyle);


    ui->btnemploye->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/employe.png"));
    ui->btnemploye->setIconSize(QSize(50, 50));
    ui->btnemploye->setStyleSheet(commonButtonStyle);
    ui->btnpatient->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/patient.png"));
    ui->btnpatient->setIconSize(QSize(50, 50));
    ui->btnpatient->setStyleSheet(commonButtonStyle);
    ui->btnvaccins->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/vaccins.png"));
    ui->btnvaccins->setIconSize(QSize(50, 50));
    ui->btnvaccins->setStyleSheet(commonButtonStyle);
    ui->btnequipement->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/equipement.png"));
    ui->btnequipement->setIconSize(QSize(50, 50));
    ui->btnequipement->setStyleSheet(commonButtonStyle);
    ui->btnformation->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/formation.png"));
    ui->btnformation->setIconSize(QSize(50, 50));
    ui->btnformation->setStyleSheet(commonButtonStyle);
    ui->btnrecherche->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/recherche.png"));
    ui->btnrecherche->setIconSize(QSize(50, 50));
    ui->logout->setIcon(QIcon("C:/Users/asus/Desktop/interfce/logout1.png"));
    ...
    ui->pdf->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/pdf2.png"));
    ui->pdf->setIconSize(QSize(91, 51));
    ui->pdf->setStyleSheet("QPushButton { border: 0px; background: transparent; }");
    ui->pdf_2->setIcon(QIcon("C:/Users/asus/Desktop/project/interfce/sta.png"));
    ...
    if(test)
    {
        ...
        QMessageBox::information(this, QObject::tr("Database Connection"),
                                 QObject::tr("Connection successful."),
                                 QMessageBox::Ok);
    }
    else
    {
        QMessageBox::critical(this, QObject::tr("Database Connection"),
    ...
    trayIcon->setIcon(QIcon(":/new/prefix1/fire.png")); // Set your app icon here
    trayIcon->show();

    notificationTimer = new QTimer(this);
    connect(notificationTimer, &QTimer::timeout, this, &MainWindow::checkUpcomingFormations);
    notificationTimer->start(6000); // Check every minute (60,000 ms)
   ...
   loadFormationData();
    ...
    connect(ui->calendarWidget, &QCalendarWidget::currentPageChanged,
            this, &MainWindow::onCalendarPageChanged);
    ...
    ///pdf///
    connect(ui->pdf_3, &QPushButton::clicked, this, &MainWindow::on_pdf_clicked);
...
void MainWindow::setupParticipantStatsChart()
{
...
///CALENDRIER///
void MainWindow::highlightFormationDates()
{
...
///NOTIFICATION///
void MainWindow::checkUpcomingFormations()
{
    ...
    if (data.contains("M")) {
        ...
        if (query.exec() && query.next()) {
            ...
            if (current < max) {
                ...
                ui->label_18->setText("Porte ouverte pour 3 sec ");
                int par = current;
                int nbr = max;
                ...
                ui->label_18->setText("Porte fermée - nombre max atteint");
            ...
            ui->label_18->setText("Erreur lecture base");
