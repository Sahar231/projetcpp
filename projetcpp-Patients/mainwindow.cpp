    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->pushButton_6, &QPushButton::clicked, this, &MainWindow::genererPDFPatients);
...
void MainWindow::genererPDFPatients()
{
...
void MainWindow::sendEmail(QString recipient, QString subject, QString body)
{
...
void MainWindow::on_pushButton_9_clicked()
{
    ...
    QString message =
        ...
        + QString("Nom : %1 %2 | ID : %3 | né(e) le : %4 ans.\n\n")
              .arg(prenom, nom)
              .arg(id)
              .arg(age)
        + "Cordialement,\n"
