...
namespace {
struct qt_meta_tag_ZN2iaE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN2iaE = QtMocHelpers::stringData(
    "ia",
    "on_btnAjouterImage_2_clicked",
    "",
    "handleAPIResponse",
    "QNetworkReply*",
    "reply"
...
Q_CONSTINIT static const uint qt_meta_data_ZN2iaE[] = {
...
Q_CONSTINIT const QMetaObject ia::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN2iaE.offsetsAndSizes,
    qt_meta_data_ZN2iaE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN2iaE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ia, std::true_type>,
        // method 'on_btnAjouterImage_2_clicked'
...
void ia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_btnAjouterImage_2_clicked(); break;
...
void *ia::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN2iaE.stringdata0))
