...
static constexpr auto qt_meta_stringdata_ZN12ImageHandlerE = QtMocHelpers::stringData(
    "ImageHandler",
    "save",
    "",
    "imageObj",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ImageHandlerE[] = {
...
Q_CONSTINIT const QMetaObject ImageHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ImageHandlerE.offsetsAndSizes,
    qt_meta_data_ZN12ImageHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ImageHandlerE_t,
        // Q_OBJECT / Q_GADGET
...
void *ImageHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ImageHandlerE.stringdata0))
