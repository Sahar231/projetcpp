...
patie::patie(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::patie)
{
    ui->setupUi(this);
    connect(ui->tableView, SIGNAL(clicked(QModelIndex)), this, SLOT(on_tableView_rowSelected(QModelIndex)));
    connect(ui->pushButton_6, &QPushButton::clicked, this, &patie::genererPDFPatients);
...
void patie::on_pushButton_4_clicked() // ajout
{
...
void patie::displayPatients() // affichage
{
...
void patie::on_tableView_clicked(const QModelIndex &index)
{
    if (index.isValid()) {
...
void patie::on_pushButton_2_clicked() // suppression
{
...
void patie::on_pushButton_3_clicked() // modifier
{
    if (selectedPatientId.isEmpty()) {
...
void patie::on_tableView_rowSelected(const QModelIndex &index)
{
...
void patie::on_pushButton_7_clicked() // TRI ET RECHERCHE
{
...
void patie::genererPDFPatients() // PDF
{
...
void patie::on_pushButton_8_clicked() // stats
{
...
void patie::sendEmail(QString recipient, QString subject, QString body)
{
...
void patie::on_pushButton_9_clicked() // EMAIL
{
...
void patie::on_pushButton_5_clicked() // SMS
{
    QModelIndex index = ui->tableView->currentIndex();
...
void patie::on_btnemploye_clicked()
{
    user *u=new user();
    u->show();
    this->hide();
...
void patie::on_btnvaccins_clicked()
{
...
void patie::on_btnequipement_clicked()
{
    equip *e = new equip();
    e->show();
    this->hide();
...
void patie::on_btnformation_clicked()
{
    forma *f= new forma();
    f->show();
    this->hide();
...
void patie::on_btnrecherche_clicked()
{
    projet *r=new projet();
    r->show();
    this->hide();
...
void patie::on_pushButton_clicked()
{
    displayPatients();
}


void patie::on_logout_clicked()
{
    login *l=new login();
    l->show();
    this->hide();
